...
$(document).ready(function () {
  ...
  // Owl Carousel - Two-column carousels (Spa Days, Yoga, Feasting, etc.)
  $(".two-col .owl-carousel")
    .not('[id^="carousel-dome-"]')
    .not('#carousel-wellness-retreats')
    .each(function () {
      $(this).owlCarousel({
      ...
      // Process images in each two-column carousel
      const images = $(this).find('.item img');
